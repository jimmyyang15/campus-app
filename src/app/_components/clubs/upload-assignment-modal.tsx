...
import { AssignmentSchema, AssignmentSchemaType } from '@/lib/schemas/assignment';
...
const UploadAssignmentModal = () => {
  ...
  function onSubmit(values: AssignmentSchemaType) {
  ...
  return (
    ...
    <CredenzaTrigger asChild>
      <li className="flex cursor-pointer text-gray-500 text-sm flex-col items-center gap-y-2">
        <FileUp />
        <p>
        Upload assignment
    ...
    <CredenzaContent>
      <CredenzaHeader>
        <CredenzaTitle className="text-center">Upload Assignment</CredenzaTitle>
      </CredenzaHeader>
