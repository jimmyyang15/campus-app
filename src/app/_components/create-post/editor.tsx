...
import { TableCellElement, TableCellHeaderElement } from '@/app/_components/plate-ui/table-cell-element';
...
export function PlateEditor({ onChange}:{onChange:()=>void}) {
  return (
    <DndProvider backend={HTML5Backend}>
      <CommentsProvider users={{}} myUserId="1">
        <Plate plugins={plugins} onChange={onChange}  initialValue={initialValue}>
          <FixedToolbar>
            <FixedToolbarButtons />
          </FixedToolbar>
