  ...
  return (
    <div className='flex items-center border-t border-gray-100 p-2'>
      ...
      <div className='overflow-hidden pl-2'>
        ...
        <div className='truncate text-xs text-neutral-500 dark:text-neutral-400'>{`:${emoji?.id}:`}</div>
      </div>
    </div>
  );
}
...
function PickAnEmoji({ i18n }: PickAnEmojiPreviewProps) {
  return (
    <div className='flex items-center border-t border-gray-100 p-2'>
      ...
      <div className='overflow-hidden pl-2'>
        <div className='truncate text-lg text-neutral-500 dark:text-neutral-400'>
          {i18n.pick}
        </div>
      </div>
    </div>
